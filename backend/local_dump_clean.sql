...
CREATE TABLE `bookings` (
  ...
  `pickup_odometer_km` int(11) DEFAULT NULL CHECK (`pickup_odometer_km` is null or `pickup_odometer_km` >= 0),
  `return_odometer_km` int(11) DEFAULT NULL CHECK (`return_odometer_km` is null or `return_odometer_km` >= `pickup_odometer_km`),
