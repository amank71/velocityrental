  ...
  return (
    <>
      ...
      <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
        {visible.map((vehicle) => {
          let imageUrl = "https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&w=800&q=80"; // Default car
          if (vehicle.vehicle_type === "bike") imageUrl = "https://images.unsplash.com/photo-1558981403-c5f9899a28bc?auto=format&fit=crop&w=800&q=80";
          if (vehicle.model?.toLowerCase().includes("swift")) imageUrl = "https://images.unsplash.com/photo-1541899481282-d53bffe3c35d?auto=format&fit=crop&w=800&q=80";
          if (vehicle.model?.toLowerCase().includes("creta") || vehicle.model?.toLowerCase().includes("suv")) imageUrl = "https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?auto=format&fit=crop&w=800&q=80";
          if (vehicle.model?.toLowerCase().includes("innova") || vehicle.vehicle_type === "muv") imageUrl = "https://images.unsplash.com/photo-1629897048514-3dd741427bb8?auto=format&fit=crop&w=800&q=80";
